...
//       {error ?
//         <div className="min-h-[50vh] bg-primary-200 w-full flex items-center justify-center">
...
//                       <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${agent.is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
...
export default function CreateAgentTable() {
  ...
  const handleToggleActiveness = async (uid, currentStatus) => {
    try {
      setTogglingAgent(uid); // Set the currently toggling agent

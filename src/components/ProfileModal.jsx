...
//               onChange={handleChange}
//               className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-primary focus:border-primary appearance-none bg-white"
//             >
...
//           <button
//             type="submit"
//             className="w-full flex justify-center items-center gap-2 py-3 px-4 bg-primary text-white rounded-lg hover:bg-primary/90 transition-colors"
//           >
...
const ProfileModal = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 flex items-start justify-center z-[5005] overflow-y-auto pt-20 pb-10">
      ...
      <div 
        ref={modalRef}
        className="bg-white w-full max-w-[500px] rounded-2xl flex flex-col max-h-[80vh] relative z-10"
